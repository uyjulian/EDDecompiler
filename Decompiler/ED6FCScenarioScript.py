...
class ScenarioEntryPoint:
    ...
    def binary(self):
        return struct.pack('<lllHHllllllllHHHHHHHHHH',
                    LONG(self.Unknown_00).value,
                    LONG(self.Unknown_04).value,
                    LONG(self.Unknown_08).value,
                    USHORT(self.Unknown_0C).value,
                    USHORT(self.Unknown_0E).value,
                    LONG(self.Unknown_10).value,
                    LONG(self.Unknown_14).value,
                    LONG(self.Unknown_18).value,
                    LONG(self.Unknown_1C).value,
                    LONG(self.Unknown_20).value,
                    LONG(self.Unknown_24).value,
                    LONG(self.Unknown_28).value,
                    LONG(self.Unknown_2C).value,
